export const NAVIGATION_MAIN_STACK = 'MainStack';
export const NAVIGATION_MAIN_TABS = 'MainTabs';

export const NAVIGATION_HOME_STACK = 'HomeStack';
export const NAVIGATION_HOME_SCREEN = 'HomeScreen';

export const NAVIGATION_MAKING_STACK = 'MakingStack';
export const NAVIGATION_MAKING_HOME_SCREEN = 'MakingHomeScreen';
